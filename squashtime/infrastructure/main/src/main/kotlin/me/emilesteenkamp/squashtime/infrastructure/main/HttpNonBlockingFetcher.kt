...
internal class HttpNonBlockingFetcher
    ...
    constructor(
        ...
        override suspend fun fetch(request: Request): Result = httpClient.request(request.toHttpRequest()).toResult()
        ...
        companion object {
            ...
            private fun Method.toHttpMethod(): HttpMethod =
                when (this) {
            ...
            private suspend fun HttpResponse.toResult(): Result =
                Result(
                    ...
                    cookies =
                        this.setCookie().map { cookie ->
                            cookie.toDomainCookie(
                                this.request.url
                                    .toString()
                                    .urlOrigin,
                            )
            ...
            private fun io.ktor.http.Cookie.toDomainCookie(origin: String): Cookie {
                ...
                val domain =
                    when (val domainUrl = this.domain) {
