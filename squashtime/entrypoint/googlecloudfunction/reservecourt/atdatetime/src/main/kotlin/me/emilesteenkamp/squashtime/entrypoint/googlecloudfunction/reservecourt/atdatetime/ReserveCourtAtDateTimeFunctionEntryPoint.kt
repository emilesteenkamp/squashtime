package me.emilesteenkamp.squashtime.entrypoint.googlecloudfunction.reservecourt.atdatetime
...
@Suppress("Unused")
class ReserveCourtAtDateTimeFunctionEntryPoint : HttpFunction by ReserveCourtFunction(
